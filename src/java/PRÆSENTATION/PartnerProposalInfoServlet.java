...
@WebServlet(name = "PartnerProposalInfoServlet", urlPatterns = {"/PartnerProposalInfoServlet"})
public class PartnerProposalInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("PartnerProposalInfo.jsp").forward(request, response);
            } else {
